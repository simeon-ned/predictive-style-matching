...
# Motion conversion: foot bodies and sole height for vertical debias (from foot capsules).
MOTION_Z_DEBIAS_FOOT_BODY_NAMES: tuple[str, ...] = (
  "left_ankle_roll_link",
  "right_ankle_roll_link",
)
# Distance from foot body origin down to ground contact plane (from MJCF foot collision geoms).
