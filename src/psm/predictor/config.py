...
# Training motion: stacked bundle (fast) or per-clip NPZ glob (slow if not augmented).
MOTION_BUNDLE_PATH = "data/motions/motions.npz"
MOTION_FILES_PATTERN = MOTION_BUNDLE_PATH
MOTION_CLIP_GLOB = "data/motions/*.npz"
